...
# #         tk_back = tk.PhotoImage(file="C:/Users/PauloSouza/Desktop/Restaurante/background.jpg").subsample(5, 5)
# #         self.menu_window.config(image=tk_back)
...
# #         self.confirmation_window.geometry("400x400")

# #         tk.Label(self.confirmation_window, text="Obrigado pelo seu pedido!", font=("Arial", 20)).pack(pady=20)
# #         tk.PhotoImage(file="fun_image.png").subsample(2, 2).pack(pady=20)  
...
# #     tk.Label(self.confirmation_window, text="Obrigado pelo seu pedido!", font=("Arial", 20)).pack(pady=20)
# #     tk.PhotoImage(file="C:/Users/PauloSouza/Desktop/Restaurante/ederson.png") 
...
#         try:
#             # Load the image
#             tk_cachorro = tk.PhotoImage(file="C:/Users/PauloSouza/Desktop/Restaurante/cachorro.png").subsample(5, 5)
#             # Keep a reference to the image
#             self.tk_cachorro = tk_cachorro  # Store reference
#             # Create a button with the image
#             botao_entradas = tk.Button(self.confirmation_window, image=tk_cachorro)
#             botao_entradas.grid(row=1, column=0, pady=20, padx=50, sticky="nw")
#         except tk.TclError as e:
#             print(f"Error loading image: {e}")

#         # Display a description
#         desc_entradas = tk.Label(self.confirmation_window, text="ENTRADAS", font=("Arial", 10))
#         desc_entradas.grid(row=2, column=0, sticky="nw", padx=65)

#         # Run the main loop for the confirmation window
#         self.confirmation_window.mainloop()

# # Initialize the system (ensure this is part of the correct context in your code)
# if __name__ == "__main__":
#     sistema = Sistema()
#     sistema.order_window = tk.Tk()  # Example placeholder for order_window
#     sistema.order_window.withdraw()  # Hide the initial window
#     sistema.confirmar_pedido()
...
class Sistema:
    def confirmar_pedido(self):
        # Destroy the previous order window
        self.order_window.destroy()
        ...
        # Load and display the image on a button
        try:
            tk_pedidos = tk.PhotoImage(file="C:/Users/PauloSouza/Desktop/Restaurante/pedir.png").subsample(5, 5)
            self.tk_pedidos = tk_pedidos  # Keep a reference to avoid garbage collection
            botao_pedidos = tk.Button(self.confirmation_window, image=tk_pedidos, command=self.confirmation_window.destroy)
            botao_pedidos.grid(row=1, column=0, pady=20, padx=50, sticky="s")
        except tk.TclError as e:
            print(f"Error loading image: {e}")

        # Add a label below the button
        desc_pedidos = tk.Label(self.confirmation_window, text="CONFIRMAR PEDIDO", font=("Arial", 10))
        desc_pedidos.grid(row=2, column=0, sticky="s", padx=50)
